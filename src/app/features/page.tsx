  ...
  const paths = [
    {
      ...
      description:
        "Start your journey with alphabet mastery, pronunciation basics, and essential phrases that build your language foundation.",
      bgColor: "bg-[#FFEEEE]",
    ...
    },
    {
      ...
      description:
        "Expand your word power with thematic vocabulary lessons covering travel, business, academics, and everyday conversations. Practice with flashcards and spaced repetition.",
    ...
    },
    {
      ...
      description:
        "Progress from basic sentence structures to advanced grammar concepts with rule-based examples and interactive exercises.",
      bgColor: "bg-[#D2E8E3]",
      textColor: "text-black",
      badgeColor: "bg-[#E6E6E6]",
      image: "/students.jpg",
  ...
  const FeatureBlock = ({
    ...
    >
      ...
      <div className="flex items-center gap-2 bg-white px-1.5 py-1 rounded-full shadow-md border border-slate-100 mb-3 transition-transform hover:scale-105 cursor-default">
        ...
        <h3 className="font-semibold text-slate-800 text-[16px] md:text-base lg:text-[18px]">
          {data.title}
        </h3>
      </div>
      <div
    ...
    <div className="flex flex-col min-h-screen bg-black">
      <div className="relative w-full max-w-[1440px] mx-auto overflow-hidden min-h-[600px] lg:h-[578px] flex flex-col">
        ...
        <div className="relative z-20 flex flex-col items-center justify-center px-4 py-12 lg:py-0 flex-grow">
          <div
            className={`${inter.className} max-w-[1030px] w-full text-center`}
          >
            <h1 className="text-[32px] md:text-[48px] lg:text-[56px] font-semibold  text-black tracking-tight">
              Built for learners. Trusted by institutions. Powered by
              intelligence.
            </h1>
            <p className="text-[16px] md:text-[18px] font-normal text-gray-800 max-w-[950px] mx-auto font-inter leading-tight tracking-tight">
              ILLP blends structured curriculum, expert-led instruction, and
              AI-powered practice to deliver measurable language outcomes—at
      ...
      <div className="w-full max-w-[1440px] mx-auto bg-black relative z-10">
        ...
        <section
          className={`${inter.className} mx-auto w-full max-w-[1440px] min-h-[637px] overflow-hidden bg-[#F7FFFA] flex items-center justify-center z-10`}
        >
            ...
            <div className="flex flex-col gap-6 w-full lg:max-w-[630px] lg:ml-16 order-2 lg:order-1">
              <div className="flex flex-col space-y-4 md:space-y-[16px]">
                ...
                <p className="text-[14px] md:text-[16px] text-gray-800 leading-relaxed font-inter">
                  Experience breakthrough language learning with our GPT-powered
                  AI tutor that adapts to your pace and style. Practice
                  conversations naturally, receive instant pronunciation
                  feedback, and track your fluency improvements in real-time.
                </p>
                ...
                <div className="space-y-4 md:space-y-[24px] mt-4">
                  {features.map((item, idx) => (
                    ...
                    >
                      <h3 className="font-semibold text-[15px] md:text-[16px] text-gray-900">
                        {item.title}
                      </h3>
      ...
      <div className="w-full max-w-[1440px] mx-auto bg-black relative z-10">
          ...
          <section className="py-16 px-4 md:px-10 bg-white">
            <div className="max-w-[1240px] mx-auto flex flex-col items-center">
              ...
              <div className="flex items-center gap-2 px-2 py-2 border border-gray-200 rounded-full w-fit">
                ...
                <span className="text-[16px] font-medium font-inter text-gray-900">
              ...
              <h2 className="text-3xl md:text-[32px] lg:text-[40px] font-semibold text-center mt-6 text-gray-900 max-w-[763px] leading-tight">
                ...
                <span className="text-gray-600 font-normal font-inter text-[16px] lg:text-[32px]">
          ...
          <div className="max-w-[1440px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="max-w-[941px] mx-auto text-[16px] text-gray-600 font-inter px-4">
                A structured, internationally aligned learning framework that
                guides learners from foundational language skills to advanced
                proficiency, with integrated exam preparation and career
            ...
            <div className="bg-[#2D4A43] w-full max-w-[1240px] mx-auto rounded-[24px] overflow-hidden flex flex-col lg:flex-row text-white p-6 lg:p-10">
              ...
              <div className="lg:w-1/2 px-2 md:px-8 w-full h-fit max-w-[588px] min-h-fit lg:h-[340px] flex flex-col justify-center gap-6 mt-8 lg:mt-0">
                ...
                <p className="px-2 text-[16px] md:text-[18px] font-normal opacity-90 leading-relaxed font-inter">
                  Designed for absolute beginners, this level builds confidence
                  from day one by focusing on sounds, letters, and everyday
                  expressions.
                </p>

                <button className="mt-10 lg:mt-20 w-full lg:w-full px-4 md:px-1 lg:px-50 py-3 bg-black text-white rounded-full font-medium font-inter text-[14px] md:text-[16px] whitespace-nowrap flex justify-center items-center hover:bg-gray-900 transition-all active:scale-[0.98]">
                  Start Pre-A1
                </button>
              </div>
            </div>
        ...
        <section className="relative min-h-[600px] w-full flex flex-col items-center justify-center bg-black text-white px-6 py-16 overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1240px] w-full  text-center">
            ...
            <h2 className="text-[32px] md:text-[40px] font-semibold mb-4 leading-[1.2] font-inter">
              Track Progress with Intelligent <br className="hidden md:block" />{" "}
              Assessments
            </h2>
            <p className="text-gray-400 max-w-[650px]  mx-auto mb-16 text-[14px] md:text-[16px] font-inter leading-relaxed">
              Move beyond guesswork with our multi-layered assessment engine
              that evaluates every aspect of your language proficiency.
            </p>
            {/* Feature Cards Grid */}
                  ...
                  <div>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        borderTop: "1px solid",
                        borderImageSource:
                          "linear-gradient(270deg, rgba(255, 255, 255, 0.1) 0%, #FFFFFF 100%)",
                        borderImageSlice: 1,
                      }}
                    />
        ...
        <section className="w-full px-4 py-12 flex justify-center bg-white">
          ...
          <div className="max-w-[1240px] w-full min-h-fit lg:min-h-[500px] bg-[#2D4A43] mx-auto rounded-[24px] overflow-hidden flex flex-col lg:flex-row p-8 lg:p-12 gap-8 relative">
            ...
            <div className="relative mt-8 w-full h-[300px] lg:absolute lg:mt-0 lg:top-[39px] lg:left-[728px] lg:w-[482px] lg:h-[422px]">
        ...
        <section className="min-h-[800px] bg-white p-6 md:p-12 lg:p-24">
            ...
            <div className="flex-1 w-full">
              <div className="mb-12">
                ...
                <p className="text-gray-600 text-base md:text-[16px] font-normal font-inter lg:max-w-[650px] ">
                  A single platform that consolidates academic delivery,
                  practice, administration, and assessment—without
                  fragmentation.
                </p>
              </div>
        ...
        <section className="relative max-[1440px] bg-[#fcfdfa] overflow-hidden py-10 px-6">
          ...
          <div className="max-w-[763px] mx-auto text-center mb-10 z-20 relative">
            ...
            <p className="text-gray-800 lg:text-[16px] md:text-[14px]  font-normal font-inter  mx-auto max-w-[700px] leading-relaxed">
              Transform your institution into a language learning powerhouse
              with our complete white-label solution. Get your own branded
              platform with zero technical hassle.
            </p>
          </div>

          {/* --- CONNECTING LINES SVG (Desktop Only) --- */}
          {/* --- FOUR INDEPENDENT CONNECTORS --- */}
          {/* --- INDEPENDENT CONNECTOR CONTAINERS --- */}
          <div className="absolute inset-0 pointer-events-none hidden lg:block z-10  mt-40 ">
            {/* 1. LEFT TOP CONNECTOR */}
            <div className="absolute inset-0 pr-38 pointer-events-none">
              <svg
            ...
            {/* 2. LEFT BOTTOM CONNECTOR */}
            <div className="absolute inset-0 pr-41 mb-3 pointer-events-none">
              <svg
                className="w-full h-full"
                viewBox="0 0 1200 800"
                fill="none"
            ...
            {/* 3. RIGHT TOP CONNECTOR */}
            {/* RIGHT SIDE CONNECTORS */}
            <div className="absolute inset-0 pl-32 pointer-events-none">
            ...
            {/* 4. RIGHT BOTTOM CONNECTOR */}
            <div className="absolute inset-0 pl-34 mb-3 pointer-events-none">
              <svg
                className="w-full h-full"
                viewBox="0 0 1200 800"
                fill="none"
          ...
          <div className="max-w-[1240px] z-20 w-full mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-12 items-center relative">
            ...
            {/* Right Features */}
            <div className="flex flex-col ml-10 lg:items-start z-20">
        ...
        <section className="bg-white py-16 px-6 md:px-12 lg:px-24 ">
          ...
          <div className="text-center max-w-[865px] mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-[40px] font-inter font-semibold text-gray-900 mb-4">
              Structured Practice. Measurable Progress.
            </h2>
            <p className="text-gray-800 leading-relaxed tracking-wide text-[12px] md:text-[16px]  font-inter ">
              The ILLP Language Lab is designed as a comprehensive digital
              practice environment that supports core language skills through
              guided exercises, real-time evaluation, and instructor oversight.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-[1240px] w-full mx-auto">
            ...
            <div className="p-8 md:p-10 border-[#E6E6E6] border-b md:border-r lg:border-r lg:border-b flex flex-col items-start">
              ...
              <h3 className="text-[24px] font-inter font-semibold text-gray-800 mb-3">
                Interactive Exercises
              </h3>
              <p className="text-gray-700 text-[16px] font-inter leading-relaxed tracking-wide">
                Each exercise is auto-evaluated with instant scoring, ensuring
                immediate clarity on performance. Upon completion, students
                receive:
              </p>
            </div>
            ...
            <div className="p-8 md:p-10 border-[#E6E6E6] border-b lg:border-r lg:border-b flex flex-col items-start">
              ...
              <p className="text-gray-700 text-[16px] font-inter leading-relaxed tracking-wide">
                The reading module strengthens comprehension through carefully
                curated passages aligned with lesson objectives. Learners
                develop:
              </p>
            </div>
            ...
            <div className="p-8 md:p-10 border-[#E6E6E6] border-b md:border-r lg:border-r-0 lg:border-b flex flex-col items-start">
              ...
              <p className="text-gray-700 text-[16px] font-inter leading-relaxed tracking-wide">
                Writing exercises are aligned with the active lesson or module,
                helping learners structure thoughts logically, express ideas
                clearly, improve grammatical accuracy.
              </p>
            </div>
            ...
            <div className="p-8 md:p-10 border-[#E6E6E6] border-b md:border-r-0 lg:border-r lg:border-b-0 flex flex-col items-start">
              ...
              <p className="text-gray-700 text-[16px] font-inter leading-relaxed tracking-wide ">
                This creates a low-pressure environment where learners can
                practice speaking freely, gradually building confidence,
            ...
            <div className="p-8 md:p-10 border-[#E6E6E6] border-b md:border-b-0 md:border-r lg:border-r flex flex-col items-start">
              ...
              <h3 className="text-[24px] font-semibold font-inter text-gray-800 mb-3">
                Vocabulary Practice
              </h3>
              <p className="text-gray-700 text-[16px] font-inter leading-relaxed tracking-wide">
                Vocabulary sessions focus on key words and phrases drawn
                directly from lesson content. Through targeted exercises,
                learners reinforce:
              </p>
            </div>
            ...
            <div className="p-8 md:p-10 flex flex-col items-start ">
              ...
              <p className="text-gray-700 text-[16px] font-inter leading-relaxed tracking-wide">
                Instructors can assign structured homework directly through the
                platform. Assignments Retention through repetition
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#2D4A43] p-6 md:p-12 lg:p-16 max-w-[1440px] w-full mx-auto flex flex-col lg:flex-row items-center justify-center gap-8 xl:gap-10 ">
          ...
          <div className="w-full lg:flex-1 lg:max-w-[560px] flex flex-col justify-center text-white">
            ...
            <p className="text-gray-300 text-sm md:text-base lg:text-[16px] font-inter leading-relaxed tracking-wide">
              The AI-based evaluation module enables learners to engage in
              structured, natural conversations that closely simulate real-world
              communication. Designed to complement traditional language
              training methods, this module accelerates skill development
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-[1240px] mx-auto ">
            ...
            <div className="border-l-4 border-[#31564E] pl-6 max-w-[344px] bg-[linear-gradient(90deg,#F2F2F2_0%,rgba(242,242,242,0.1)_100%)]">
              ...
              <p className="  font-inter text-gray-600 leading-relaxed text-[16px] max-w-[344px]">
                From course structure to assessments, everything feels
                thoughtfully designed. This is not just another learning app;
                it’s a dependable platform for long-term skill development.
              </p>
            </div>
            ...
            <div className="border-l-4 border-[#31564E] pl-6 max-w-[344px] bg-[linear-gradient(90deg,#F2F2F2_0%,rgba(242,242,242,0.1)_100%)]">
              ...
              <p className="font-inter text-gray-600 leading-relaxed text-[16px] max-w-[344px]">
                The dashboard and progress tracking gave me clarity on where I
                stood and what to focus on next. It’s reassuring to learn on a
                platform that values discipline and consistency, not shortcuts.
              </p>
            </div>
            ...
            <div className="border-l-4 border-[#31564E] pl-6 max-w-[344px] bg-[linear-gradient(90deg,#F2F2F2_10%,rgba(242,242,242,0.1)_100%)]">
              ...
              <p className="font-inter text-gray-600 leading-relaxed text-[16px] max-w-[344px]">
                The AI tutor isn’t just a feature—it genuinely supports
                improvement in speaking and pronunciation. It feels like a
                modern solution built on traditional teaching principles.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="min-h-[700px] bg-white py-12 px-4 font-sans text-gray-800">
          ...
          <header className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-gray-500 leading-relaxed max-w-[941px] mx-auto text-[16px] font-inter font-medium">
              ILLP follows a progressive, level-based curriculum where each
              level consists of 10–25 focused modules, and each module contains
              multiple lessons, practice activities, and assessments.
            </p>
          </header>
        ...
        <section className="bg-[#2D4A43] max-w-[1440px] mx-auto min-h-[600px] p-8 md:p-16 flex items-center justify-center">
          <div className="  max-w-[1240px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-white space-y-4 max-w-[610px]">
              ...
              <h1 className="text-4xl md:text-[40px] font-semibold font-inter">
                How It Works
              </h1>

              <p className="text-gray-200 text-[16px] font-inter leading-relaxed tracking-wide">
                Learners can independently select real-world communication
                topics such as “Asking permission for leave”, “Handling
                workplace conversations”, or “Everyday social interactions.”
                Once a topic is chosen, the AI Tutor initiates an interactive,
                two-way dialogue, simulating a natural classroom conversation.
              </p>
                ...
                {aimodule.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="text-sm md:text-[16px] font-inter text-gray-200">
                      <span className="font-medium text-[16px] font-inter text-white">
                        {feature.title}
                      </span>{" "}
                      – {feature.desc}
                    </p>
