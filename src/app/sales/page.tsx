  ...
  return (
    ...
    */}
            <div className="flex flex-col md:flex-row items-center justify-center gap-[16px] z-30 mt-10 min-h-[51px] w-full max-w-[406px] md:max-w-none mx-auto">
              <button className="w-full md:w-[201px] h-[51px] bg-black text-white rounded-full font-semibold text-[16px] transition-all hover:bg-[#31564E] active:scale-95 shadow-lg">
                Apply for Sales Role
              </button>

              <button className="w-full md:w-[206px] h-[51px] border-2 border-[#31564E] text-[#31564E] rounded-full font-semibold text-[16px] transition-all hover:bg-[#31564E] hover:text-white active:scale-95 bg-white/50 backdrop-blur-sm">
        ...
        <div className="w-full max-w-[1240px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
            {features.map((feature, index) => (
              <div
                key={index}
                className={`p-8 rounded-2xl text-left w-full max-w-[400px] min-h-[174px] transition-transform hover:scale-[1.02] cursor-default flex flex-col justify-start ${
                  feature.dark
              ...
              >
                <h3
                  className={`text-[22px] md:text-[24px] font-inter font-semibold mb-2 ${
                    feature.dark ? "text-white" : "text-[#345249]"
                  }`}
                >
                  {feature.title}
                </h3>
                <p
                  className={`text-[15px] md:text-[16px] font-inter font-regular ${
                    feature.dark ? "text-gray-200" : "text-gray-600"
                  }`}
                >
                  {feature.description}
                </p>
              ...
              {jobs.map((job, index) => (
                ...
                >
                  ...
                  <div className="border-t border-[#E6E6E6] pt-6 flex items-center justify-between gap-2">
                    ...
                    <button className="active:scale-95 bg-black text-white w-[140px] md:w-[149px] h-[51px] px-4 md:px-6 py-3 rounded-full text-sm font-semibold hover:bg-gray-800 transition-all flex-shrink-0">
                      View & Apply
                    </button>
                  </div>
                </div>
